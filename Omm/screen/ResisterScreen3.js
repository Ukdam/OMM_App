...
function ResisterScreen3({ route, navigation }) {
    ...
    const { username, password, name, tel, email, mainadress, sideAddress } = userData2;
    ...
    async function Resister(e) {
        ...
        try {
            response = await fetch("http://172.20.10.2:4000/register", {
                method: "POST",
                body: JSON.stringify({ username, password, name, tel, email, mainadress, sideAddress, Check1, Check2, Check3 }),
